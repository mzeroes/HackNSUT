  ...
  render() {
    return (
      <View style={{ backgroundColor: Theme.background }}>
        <TopHeader
          title={
            this.state.data ? 'Update The Expenses'
              : 'Add Expenses'}
                ...
                <WithIcon>
                  ...
                  <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-evenly' }}>
                    ...
                    <Chip
                      ...
                      selected={this.state.clothing}
                      onPress={() => {
                        setFieldValue('category', 'clothing');
                        this.unselectOthers('clothing');
                      }}
                    >
                        Clothing
                    </Chip>
                    <Chip
                      ...
                      onPress={() => {
                        ...
                        this.unselectOthers('entertainment');
                      }}
                    >
                        Entertainment
                    ...
                    <Chip
                      ...
                      onPress={() => {
                        setFieldValue('category', 'food');
                        this.unselectOthers('food');
                      }}
                    >
                        Food
                    </Chip>
                    <Chip
                      style={{ marginBottom: 10 }}
                      selected={this.state.fuel}
                      onPress={() => {
                        setFieldValue('category', 'fuel');
                        this.unselectOthers('fuel');
                      }}
                    >
                        Fuel
                    </Chip>
                    <Chip
                      ...
                      style={{ marginBottom: 10 }}
                      onPress={() => {
                        setFieldValue('category', 'health');
                        this.unselectOthers('health');
                      }}
                    >
                        health
                    </Chip>
